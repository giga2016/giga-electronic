        ...
        <div className="relative overflow-hidden">
          ...
          >
            {collaborations.map((collab, index) => (
              ...
              >
                <div className="bg-white dark:bg-gray-700 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow duration-300">
                  ...
                  <h3 className="text-sm font-semibold mb-1 dark:text-white">{collab.name}</h3>
                  <p className="text-xs text-gray-600 dark:text-gray-300">{collab.description}</p>
                </div>
              </div>
            ))}
          </div>
